...
def calculate(input_list):
    ...
    calculations = {
        'mean': [
            list(np.mean(array, axis=0)),  
            list(np.mean(array, axis=1)),  
            np.mean(array).item()
        ],
        'variance': [
            list(np.var(array, axis=0)),  
            list(np.var(array, axis=1)),  
            np.var(array).item() 
        ],
        'standard deviation': [
            list(np.std(array, axis=0)),  
            list(np.std(array, axis=1)),  
            np.std(array).item() 
        ],
        'max': [
            list(np.max(array, axis=0)), 
            list(np.max(array, axis=1)), 
            np.max(array).item() 
        ],
        'min': [
            list(np.min(array, axis=0)), 
            list(np.min(array, axis=1)), 
            np.min(array).item() 
        ],
        'sum': [
            list(np.sum(array, axis=0)), 
            list(np.sum(array, axis=1)), 
            np.sum(array).item() 
        ]
    }
